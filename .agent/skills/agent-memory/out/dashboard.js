...
class DashboardManager {
    ...
    async openDashboard() {
        ...
        this.panel = vscode.window.createWebviewPanel('agentMemoryDashboard', '🧠 Memory Dashboard', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    calculateStatistics(memories) {
        ...
        memories.forEach(memory => {
            ...
            if (createdBy.includes('cline'))
                agentName = 'Cline';
            else if (createdBy.includes('roocode') || createdBy.includes('roo'))
                agentName = 'RooCode';
            else if (createdBy.includes('kilocode') || createdBy.includes('kilo'))
                agentName = 'KiloCode';
            else if (createdBy.includes('continue'))
                agentName = 'Continue';
            else if (createdBy.includes('cursor'))
                agentName = 'Cursor';
