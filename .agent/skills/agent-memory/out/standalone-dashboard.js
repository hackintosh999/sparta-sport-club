...
exports.StandaloneDashboard = void 0;
...
class StandaloneDashboard {
        ...
        this.server.on('error', (err) => {
            if (err.code === 'EADDRINUSE') {
                if (attempt < this.maxRetries) {
                    ...
                    if (this.server) {
                        this.server.close();
                        this.server = http.createServer(this.server.listeners('request')[0]);
    ...
    calculateStatistics(memories) {
        ...
        memories.forEach(memory => {
            ...
            if (createdBy.toLowerCase().includes('cline'))
                agentName = 'Cline';
            else if (createdBy.toLowerCase().includes('roocode'))
                agentName = 'RooCode';
            else if (createdBy.toLowerCase().includes('kilocode'))
                agentName = 'KiloCode';
            else if (createdBy.toLowerCase().includes('continue'))
                agentName = 'Continue';
            else if (createdBy.toLowerCase().includes('cursor'))
                agentName = 'Cursor';
...
exports.StandaloneDashboard = StandaloneDashboard;
...
//# sourceMappingURL=standalone-dashboard.js.map