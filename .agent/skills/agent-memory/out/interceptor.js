...
class InterceptorManager {
    constructor(workspaceFolder, outputChannel) {
     ...
     */
    async injectClineRules(workspacePath) {
     ...
     */
    async injectRooCodeRules(workspacePath) {
...
`;
     ...
     */
    async injectKiloCodeRules(workspacePath) {
...
`;
     ...
     */
    async injectClineMemoryBank(workspacePath) {
...
`;
     ...
     */
    async injectRooCodeMemoryBank(workspacePath) {
...
`;
     ...
     */
    async injectContinueConfig(workspacePath) {
        ...
        const hasMemoryProvider = config.contextProviders?.some((p) => p.name === 'agentMemory');
