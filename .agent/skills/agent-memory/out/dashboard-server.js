...
class DashboardServer {
    ...
    start() {
        ...
        this.server.listen(this.port, () => {
            ...
            vscode.window.showInformationMessage(`Dashboard server started at ${url}`, 'Open in Browser').then(selection => {
    ...
    calculateStatistics(memories) {
        ...
        memories.forEach(memory => {
            ...
            if (createdBy.includes('cline'))
                agentName = 'Cline';
            else if (createdBy.includes('roocode'))
                agentName = 'RooCode';
            else if (createdBy.includes('kilocode'))
                agentName = 'KiloCode';
